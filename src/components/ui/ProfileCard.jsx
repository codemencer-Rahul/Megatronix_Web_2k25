  ...
  return (
    <div className="relative w-[280px] h-[380px]">
      ...
      <div className="relative rounded-2xl overflow-hidden h-full" style={{ background: 'linear-gradient(to bottom right, var(--black), var(--surface-black), var(--dark-black))', borderWidth: '2px', borderStyle: 'solid', borderColor: 'var(--yellow-primary)', boxShadow: '0 0 6px var(--yellow-shadow)', backdropFilter: 'blur(4px)' }}>
        ...
        {/* Image section */}
        <div className="relative h-[260px] overflow-hidden flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, rgba(0, 0, 0, 0.6), var(--dark-black))', borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: 'var(--yellow-border-soft)' }}>
          {imageUrl ? (
            <img
              src={imageUrl}
              alt={name}
        ...
        <div className="relative h-[120px]" style={{ background: 'linear-gradient(to bottom right, rgba(0, 0, 0, 0.6), var(--dark-black))' }}>
          ...
          <div className="absolute top-[13px] left-[110px] right-4 flex items-center justify-around px-2">
            <a href={`mailto:${email}`} className="transition-all hover:scale-110 flex items-center" style={{ color: 'var(--yellow-primary)' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--yellow-hover)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--yellow-primary)'}>
              <GmailIcon className="h-5 w-5" fill="var(--yellow-primary)" />
            </a>
            <a href={linkedin} target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 flex items-center" style={{ color: 'var(--yellow-primary)' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--yellow-hover)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--yellow-primary)'}>
              <LinkedinIcon className="h-5 w-5" fill="var(--yellow-primary)" />
            </a>
            <a href={github} target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 flex items-center" style={{ color: 'var(--yellow-primary)' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--yellow-hover)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--yellow-primary)'}>
