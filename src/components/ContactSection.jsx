            ...
            <div className="relative h-full bg-blue-700/10 backdrop-blur-sm border border-blue-700/30 rounded-xl p-8 shadow-[0_0_20px_rgba(0,243,255,0.1)] overflow-hidden">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <textarea
                  ...
                  className="w-full bg-white/5 border border-cyan-500/20 p-3 text-white placeholder-cyan-500/30 focus:outline-none focus:border-cyan-400 focus:shadow-[0_0_10px_rgba(0,243,255,0.2)] transition-all resize-none"
                ></textarea>
